...
As of this document that is **`054_cash_entry_contractor.sql`** (and everything before it, including **036–053**).  
...
- [ ] Migrations list complete through **054** (and types/docs per `SCHEMA_SSOT.md`)  
