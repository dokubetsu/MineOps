...
As of this document that is **`052_feature_gate_jsonb_safe_fields.sql`** (and everything before it, including **036–051**).  
...
- [ ] Migrations list complete through **052** (and types/docs per `SCHEMA_SSOT.md`)  
