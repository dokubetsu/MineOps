...
As of this document that is **`053_grant_api_role_table_privileges.sql`** (and everything before it, including **036–052**).  
...
- [ ] Migrations list complete through **053** (and types/docs per `SCHEMA_SSOT.md`)  
