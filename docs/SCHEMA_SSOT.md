...
|----------|----------|------|
| **1** | `supabase/migrations/*.sql` | **Source of truth** for production schema. Apply with `supabase db push` / CI. Currently through **`064_offline_idempotency_dashboard_rollup.sql`**. |
